...
class LayerLSTMGraphTest {
  ...
  def testBuildAndTrain: Unit = {
    ...
    val xval = Array(
      Nd4j.create(Array(2d, 1, 0), Array(3, 1)),
      Nd4j.create(Array(1d, 2, 1), Array(3, 1)),
      Nd4j.create(Array(0d, 1, 1), Array(3, 1)))
    ...
    graph.expect(Nd4j.create(Array(1d, 2d, 0d, 2d, 2d, 1d, 1, 0, 1), Array(3, 3)))
